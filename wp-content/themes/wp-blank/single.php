<?php get_header(); ?>
	...
	<?php if (have_posts()): while (have_posts()) : the_post(); ?>
        <?php   if ( get_post_type( get_the_ID() ) == 'wp-blank'  ) {?>
        	<!-- article -->
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<p><?php _e( 'Categorised in: ', 'wpblank' ); the_category(', '); // Separated by commas ?></p>

			<p><?php _e( 'This post was written by ', 'wpblank' ); the_author(); ?></p>
