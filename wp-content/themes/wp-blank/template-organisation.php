        ...
        <div class="bc-inner organization">
            ...
            <section class="section-001 row middle-xs center-xs" id="section-001">
                ...
                <div class="o-limbo clearfix">
                    <p class="c-next-section js-parallax" data-200-center="@class:c-next-section js-parallax" data-center="@class:c-next-section js-parallax -in-view"> <span class="c-mask">+</span> </p>
                </div>
            </section>
            <section id="section-0011" class="row middle-xs">
                <div class="c-home_block c-half_block col-xs-12 col-sm-6 c-organization_img">
                    <div class="row middle-xs center-xs">
                        <div class="img-contain -left  animated row middle-xs center-xs">
                            <div class="col-xs-12"> <span class="content box">1</span> </div>
                        </div>
                    </div>
                </div>
            ...
            <section id="section-0002" class="row middle-xs">
                ...
                <div class="c-home_block c-half_block col-xs-12 col-sm-6 c-organization_img">
                    <div class="row middle-xs center-xs">
                        <div class="img-contain -right  animated row middle-xs center-xs">
                            <div class="col-xs-12"> <span class="content box">2</span> </div>
                        </div>
                    </div>
                </div>
            </section>
            <section id="section-002" class="row middle-xs">
                <div class="c-home_block c-half_block col-xs-12 col-sm-6 c-organization_img">
                    <div class="row middle-xs center-xs">
                        <div class="img-contain -left  animated row middle-xs center-xs">
                            <div class="col-xs-12"> <span class="content box">3</span> </div>
                        </div>
                    </div>
                </div>
                <div class="c-home_block c-half_block  col-xs-12 col-sm-6  c-content_wrap o-container -medium c-organization_text" data-start="opacity:0; transform: translate(0px, 50vh) rotate(0deg)" data-center="opacity: 1; transform: translate(0px, 0px) rotate(0deg)">
            ...
            <section id="section-003" class="row middle-xs">
                ...
                <div class="c-home_block c-half_block col-xs-12 col-sm-6 c-organization_img">
                    <div class="row middle-xs center-xs">
                        <div class="img-contain -right  animated row middle-xs center-xs">
                            <div class="col-xs-12"> <span class="content box">4</span> </div>
                        </div>
                    </div>
                </div>
            </section>
            <section id="section-004" class="row middle-xs">
                <div class="c-home_block c-half_block col-xs-12 col-sm-6 c-organization_img">
                    <div class="row middle-xs center-xs">
                        <div class="img-contain -left  animated row middle-xs center-xs">
                            <div class="col-xs-12"> <span class="content box">5</span> </div>
                        </div>
                    </div>
                </div>
                <div class="c-home_block c-half_block  col-xs-12 col-sm-6  c-content_wrap o-container -medium c-organization_text" data-start="opacity:0; transform: translate(0px, 50vh) rotate(0deg)" data-center="opacity: 1; transform: translate(0px, 0px) rotate(0deg)">
            ...
            <section id="section-006" class="row middle-xs">
                ...
                <div class="c-home_block c-half_block col-xs-12 col-sm-6 c-organization_img">
                    <div class="row middle-xs center-xs">
                        <div class="img-contain -right  animated row middle-xs center-xs">
                            <div class="col-xs-12"> <span class="content box">6</span> </div>
                        </div>
                    </div>
                </div>
            </section>
